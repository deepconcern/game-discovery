...
export type SubscriptionSubscriberObject<
    TResult,
    TKey extends string,
    TParent,
    TContext,
...
> = {
    ...
    croppedBackgroundImage?: Resolver<
        Maybe<ResolversTypes['String']>,
        ParentType,
        ContextType,
        RequireFields<GameCroppedBackgroundImageArgs, 'width' | 'height'>
    >,
...
> = {
    games?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<QueryGamesArgs, 'limit'>
    >,
};
